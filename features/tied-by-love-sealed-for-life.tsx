...
export function TiedByLoveSealedForLife() {
  return (
    <footer className="h-[363px] xl:h-[540px] bg-custom-secondary-3 grid place-content-center gap-7 text-white">
      <div className="flex items-center gap-6">
        ...
        <h3 className="text-3xl xs:text-4xl xl:text-6xl font-great-vibes text-center md:w-62 xl:w-96 leading-12 xl:leading-20">
